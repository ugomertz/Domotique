...
BME280 bme;
float temperature_salon=0;
int humidity_salon=0;
...
// préparation du capteur
 ...
 rest.variable("temperature_salon",&temperature_salon);
 rest.variable("humidity_salon",&humidity_salon);
 rest.set_id("2");
 rest.set_name("sensor_module_2");
...
void loop() {
 ...
 temperature_salon = bme.readTempC();
 humidity_salon = dht.readHumidity();
