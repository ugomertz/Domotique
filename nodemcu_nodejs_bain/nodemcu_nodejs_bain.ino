...
// préparation du capteur
 ...
 rest.variable("temperature_bain",&temperature_bain);
 rest.variable("humidity_bain",&humidity_bain);
 rest.set_id("3");
 rest.set_name("sensor_module_3");
...
void loop() {
 ...
 temperature_bain = bme.readTempC();
 humidity_bain = dht.readHumidity();
